...
```{r}
    ...
    label_value <- paste('(', round(adm_gender$count / sum(adm_gender$count) *                               100, 1), '%)', sep = '')
...
Based on each admission record, the age at admission is treated as a continuous variable. The newborns take the largest part and people arount 75 years old also take a big part.
...
Based on each ICU stay record, the length of ICU stay is treated as a discrete variable. Most of the patients stay in the ICU for less than 12 days.
...
Based on each ICU stay record, the gender is treated as a discrete variable. The ratio of male patients to female patients is around 1 and the amount of male patients is larger than the amount of female patients.
...
Based on each ICU stay record, the age at admission is treated as a continuous variable. The newborns take the largest part and people arount 75 years old also take a big part.
