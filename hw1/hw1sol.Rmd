...
**solution:** Table shows that the number of times each of the four characters is mentioned:
    ...
    for name in Elizabeth Jane Lydia Darcy
        do echo $name
        grep -o $name /home/xurui1996/pride_and_prejudice.txt | wc -l
    done
    ```
...
This command outputs the author and editor information. ?
The first line of the shell script makes the command run in the `/bin/sh` shell.
